...
package com.liaopeikun.youzhong.settings;
        ...
        Preference.OnPreferenceChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        String keySaveTorrentsIn = getString(com.liaopeikun.youzhong.R.string.pref_key_save_torrents_in);
        ...
        saveTorrentsIn.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener()
        {
            ...
            {
                SettingsManager pref = new SettingsManager(getActivity().getApplicationContext());
                dirChooserBindPref = getString(com.liaopeikun.youzhong.R.string.pref_key_save_torrents_in);
        ...
        String keyMoveAfterDownload = getString(com.liaopeikun.youzhong.R.string.pref_key_move_after_download);
        ...
        String keyMoveAfterDownloadIn = getString(com.liaopeikun.youzhong.R.string.pref_key_move_after_download_in);
        ...
        moveAfterDownloadIn.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener()
        {
            ...
            {
                SettingsManager pref = new SettingsManager(getActivity().getApplicationContext());
                dirChooserBindPref = getString(com.liaopeikun.youzhong.R.string.pref_key_move_after_download_in);
                dirChooseDialog(pref.getString(dirChooserBindPref, ""));
        ...
        String keyDeleteTorrentFile = getString(com.liaopeikun.youzhong.R.string.pref_key_delete_torrent_file);
    ...
    {
        setPreferencesFromResource(com.liaopeikun.youzhong.R.xml.pref_storage, rootKey);
    }
