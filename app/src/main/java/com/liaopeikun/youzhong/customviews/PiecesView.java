...
package com.liaopeikun.youzhong.customviews;
...
public class PiecesView extends View
{
    ...
    void create()
    {
        ...
        empty.setColor(ContextCompat.getColor(getContext(), com.liaopeikun.youzhong.R.color.pieces_cell));
        complete.setColor(ContextCompat.getColor(getContext(), com.liaopeikun.youzhong.R.color.accent));
    }
