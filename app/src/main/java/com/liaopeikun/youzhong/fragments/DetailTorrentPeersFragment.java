...
import com.liaopeikun.youzhong.adapters.PeerListAdapter;
        ...
        PeerListAdapter.ViewHolder.ClickListener
{
    ...
    {
        return inflater.inflate(com.liaopeikun.youzhong.R.layout.fragment_detail_torrent_peer_list, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState)
    {
        ...
        peerList = (EmptyRecyclerView) activity.findViewById(com.liaopeikun.youzhong.R.id.peer_list);
        if (peerList != null) {
            layoutManager = new LinearLayoutManager(activity);
            peerList.setLayoutManager(layoutManager);
            peerList.setEmptyView(activity.findViewById(com.liaopeikun.youzhong.R.id.empty_view_peer_list));
            ...
            int resId = com.liaopeikun.youzhong.R.drawable.list_divider;
            if (Utils.isDarkTheme(activity.getApplicationContext())) {
                resId = com.liaopeikun.youzhong.R.drawable.list_divider_dark;
            }
            ...
            adapter = new PeerListAdapter(peers, activity, com.liaopeikun.youzhong.R.layout.item_peers_list, this);
    ...
    public boolean onItemLongClicked(int position, PeerStateParcel state)
    {
        ...
        startActivity(Intent.createChooser(sharingIntent, getString(com.liaopeikun.youzhong.R.string.share_via)));
