...
package com.liaopeikun.youzhong.fragments;
...
import com.liaopeikun.youzhong.core.TorrentMetaInfo;
import com.liaopeikun.youzhong.core.utils.FileIOUtils;
import com.liaopeikun.youzhong.core.utils.TorrentUtils;
import com.liaopeikun.youzhong.dialogs.filemanager.FileManagerConfig;
import com.liaopeikun.youzhong.dialogs.filemanager.FileManagerDialog;
...
public class AddTorrentInfoFragment extends Fragment
{
    ...
    {
        View v = inflater.inflate(com.liaopeikun.youzhong.R.layout.fragment_add_torrent_info, container, false);

        torrentNameField = (EditText) v.findViewById(com.liaopeikun.youzhong.R.id.torrent_name);
        layoutTorrentName = (TextInputLayout) v.findViewById(com.liaopeikun.youzhong.R.id.layout_torrent_name);
        sha1HashView = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.torrent_hash_sum);
        commentView = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.torrent_comment);
        createdByView = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.torrent_created_in_program);
        torrentSizeView = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.torrent_size);
        fileCountView = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.torrent_file_count);
        creationDateView = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.torrent_create_date);
        pathToUploadView = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.upload_torrent_into);
        folderChooserButton = (ImageButton) v.findViewById(com.liaopeikun.youzhong.R.id.folder_chooser_button);
        sequentialDownload = (CheckBox) v.findViewById(com.liaopeikun.youzhong.R.id.sequential_download);
        startTorrent = (CheckBox) v.findViewById(com.liaopeikun.youzhong.R.id.start_torrent);
        freeSpace = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.free_space);
        ...
        if (info != null) {
            ...
            if (TextUtils.isEmpty(info.getComment())) {
                ...
                LinearLayout commentViewLayout =
                        (LinearLayout) v.findViewById(com.liaopeikun.youzhong.R.id.layout_torrent_comment);
                commentViewLayout.setVisibility(View.GONE);

                TextView commentViewHeader = (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.header_torrent_comment);
            ...
            if (TextUtils.isEmpty(info.getCreatedBy())) {
                ...
                LinearLayout createdByViewLayout =
                        (LinearLayout) v.findViewById(com.liaopeikun.youzhong.R.id.layout_torrent_created_in_program);
                createdByViewLayout.setVisibility(View.GONE);

                TextView createdByViewHeader =
                        (TextView) v.findViewById(com.liaopeikun.youzhong.R.id.header_torrent_created_in_program);
            ...
            freeSpace.setText(
                    String.format(
                            getString(com.liaopeikun.youzhong.R.string.free_space),
    ...
    private void checkEditTextField(CharSequence s)
    {
        if (TextUtils.isEmpty(s)) {
            ...
            layoutTorrentName.setError(getString(com.liaopeikun.youzhong.R.string.error_field_required));
