...
import com.liaopeikun.youzhong.core.utils.DateFormatUtils;
...
public class DetailTorrentStateFragment extends Fragment
{
    ...
    {
        return inflater.inflate(com.liaopeikun.youzhong.R.layout.fragment_detail_torrent_state, container, false);
    }
    ...
    public void reloadInfoView()
    {
        ...
        TextView downloadUploadSpeed = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_speed);

        if (downloadUploadSpeed != null) {
            String speedTemplate = activity.getString(com.liaopeikun.youzhong.R.string.download_upload_speed_template);
        ...
        TextView downloadCounter = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_downloading);

        if (downloadCounter != null) {
            String counterTemplate = activity.getString(com.liaopeikun.youzhong.R.string.download_counter_template);
        ...
        TextView textViewETA = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_ETA);
        ...
        TextView textViewSeeds = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_seeds);

        if (textViewSeeds != null) {
            String seedsTemplate = activity.getString(com.liaopeikun.youzhong.R.string.torrent_peers_template);
            textViewSeeds.setText(
                    String.format(seedsTemplate, state.seeds, state.totalSeeds));
        }

        TextView textViewLeechers = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_leechers);

        if (textViewLeechers != null) {
            String peersTemplate = activity.getString(com.liaopeikun.youzhong.R.string.torrent_peers_template);
        ...
        TextView textViewPieces = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_pieces);

        if (textViewPieces != null) {
            String piecesTemplate = activity.getString(com.liaopeikun.youzhong.R.string.torrent_pieces_template);
        ...
        TextView textViewUploaded = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_uploaded);
        ...
        TextView shareRatio = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_share_ratio);
    ...
    {
        TextView textViewActiveTime = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_active_time);
        ...
        TextView textViewSeedingTime = (TextView) activity.findViewById(com.liaopeikun.youzhong.R.id.torrent_state_seeding_time);
